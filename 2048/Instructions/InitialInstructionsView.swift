...
struct InitialInstructionsView: View {
    ...
    @State private var hasPlayedBefore: Bool = false
        ...
        NavigationView {
            ...
            .sheet(isPresented: $showInstructionsThree) {
                VStack {
                    ...
                    NavigationLink(destination: CompositeView(board: GameLogic(size: boardSize)), isActive: $hasPlayedBefore) {
                        EmptyView()
                    }
                    .onChange(of: hasPlayedBefore) { value in
                        if value {
                            setHasPlayedBefore()
                        }
                    }
    ...
    func setHasPlayedBefore() {
        hasPlayedBefore = true
        UserDefaults.standard.set(self.hasPlayedBefore, forKey: "hasPlayedBefore")
    }
}

struct InitialInstructionsView_Previews: PreviewProvider {
